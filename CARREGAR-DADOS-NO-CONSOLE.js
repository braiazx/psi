// ============================================
// SCRIPT PARA CARREGAR DADOS FICTÍCIOS
// ============================================
// INSTRUÇÕES:
// 1. Abra o sistema em http://localhost:3002/inicio
...
(function() {
    ...
    try {
        ...
        console.log('✓ ' + clientes.length + ' clientes salvos');
        
        localStorage.setItem('eventos_ordenate', JSON.stringify(eventos));
        console.log('✓ ' + eventos.length + ' eventos salvos');
        
        localStorage.setItem('transacoes_ordenate', JSON.stringify(transacoes));
        console.log('✓ ' + transacoes.length + ' transações salvas');
        
        localStorage.setItem('anotacoes_ordenate', JSON.stringify(anotacoes));
        console.log('✓ ' + anotacoes.length + ' anotações salvas');
        
        console.log('');
        console.log('========================================');
        console.log('DADOS CARREGADOS COM SUCESSO!');
        console.log('========================================');
        console.log('Agora recarregue a página (F5)');
        console.log('');
        ...
        alert('Dados carregados com sucesso!\n\n' + 
              ...
              'Recarregue a página (F5) para ver os dados.');
